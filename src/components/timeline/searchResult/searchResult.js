...
import SidebarGroup from '../../groups/sidebar/SidebarGroup';
											...
											<div className="search--result-item">
												...
												<div className="search--text">
													...
													<div className="search--description">
														...
														<span className="span-2">· {item.countMember ? item.countMember : 0}K thành viên</span>
													...
													<div className="number--friend-joined">
														...
														<span> {item.countFriendJoinnedGroup ? item.countFriendJoinnedGroup : 0} người bạn là thành viên</span>
													</div>
												</div>
