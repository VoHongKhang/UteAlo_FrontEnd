...
test('CommentInPost', async () => {
  ...
  // tìm và ô input comment và nhập comment
  const commentInput = await driver.findElement(By.css('.post:nth-child(1) .react-input-emoji--input'));
  await commentInput.sendKeys('ducanh');

  await driver.sleep(2000);

  // tìm và click vào nút comment
  const commentButton = await driver.findElement(By.css('.post:nth-child(1) .postCommentBtn'));
